...
def create_model_form(request,admin_class):
    ...
    #     print("---obj instance",self.instance.nid)
    #
    #     error_list = []
    #     if self.instance.nid: # 这是个修改的表单
    ...
    #                 m2m_vals = [i[0] for i in m2m_objs.values_list('nid')]
    #                 set_m2m_vals = set(m2m_vals)
    #                 set_m2m_vals_from_frontend = set([i.nid for i in self.cleaned_data.get(field)])
